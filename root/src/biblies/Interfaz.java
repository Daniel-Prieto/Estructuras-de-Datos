...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JBagregarAFavoritos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JBagregarAFavoritosActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addGap(15, 15, 15)
                                .addComponent(CBordenarPor, 0, 124, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(JPingresarDatosLayout.createSequentialGroup()
                ...
                .addGroup(JPingresarDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(JPingresarDatosLayout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10))
                    .addGroup(JPingresarDatosLayout.createSequentialGroup()
                        .addComponent(JLcrearTexto)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        JPingresarDatosLayout.setVerticalGroup(
            JPingresarDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(JPingresarDatosLayout.createSequentialGroup()
                .addComponent(JLcrearTexto, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        JPbotonagregarLayout.setVerticalGroup(
            ...
            .addGroup(JPbotonagregarLayout.createSequentialGroup()
                .addGap(29, 29, 29)
                .addComponent(JBcrearTexto, javax.swing.GroupLayout.DEFAULT_SIZE, 237, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(JPingresarDatos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TFtextosrevisados, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TFnombreU, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TFapellidoU, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TFcorreo, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel8, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 564, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(JBcrearUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(42, 42, 42))
        );
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(JBborrarUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(JBusarUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        for (int i = 0; i< defaultCliente.getFavoritos().tamano; i++){
            listModel.addElement(defaultCliente.getFavoritos().toListaArrayDinamico().getArreglo()[i].toString());
        }
        ...
        try{jTextArea1.setText(defaultCliente.getLibrosPorLeer().miraVeTu().textoActual.toString());
        }catch(Exception e){
            jTextArea1.setText("No hay libros por leer");
        }

        jLabel21.setText("LIBROS POR LEER");
        ...
        this.jLabel17.setText(this.usuarios[Interfaz.currentUser].getNombre());
        this.jLabel18.setText(this.usuarios[Interfaz.currentUser].getApellido());
        this.jLabel19.setText(this.usuarios[Interfaz.currentUser].getCorreo());
        if(this.usuarios[Interfaz.currentUser] instanceof Cliente)
        {

            Cliente c = (Cliente)this.usuarios[Interfaz.currentUser];
            this.jLabel20.setText(c.getNivelAcademico());

        }else{
            this.jLabel20.setText("El usuario actual es Administrador");
        }

        jTabbedPane2.addTab("   MENU   ", jPanel9);
    ...
    private void JBguardarTextosIngresadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBguardarTextosIngresadosActionPerformed
       ...
       Texto t1;
       String titulo, autor, fecha, idioma, tema;
       int paginas=0;
        if(this.CHECKguardarEnArboles.isSelected()){
            int codigo= Acodigo.getSize();
            for(int i=0; i<this.rowsvivas;i++){
                System.out.println("arbol"+i);
                
                titulo=this.JTTABLACREAR.getValueAt(i, 0).toString();
                autor=(String) this.JTTABLACREAR.getValueAt(i, 1);
                fecha=this.JTTABLACREAR.getValueAt(i, 2).toString();
                paginas = Integer.parseInt(this.JTTABLACREAR.getValueAt(i, 3).toString());
                idioma= this.JTTABLACREAR.getValueAt(i, 4).toString();
                tema= this.JTTABLACREAR.getValueAt(i, 5).toString();
                t1= new Texto(codigo+i, titulo, autor, fecha, paginas, idioma, tema);
                Acodigo.insert(t1);
                Atitulo.insert(t1);
                Aautor.insert(t1);
        ...
        if(this.CHECKguardarEnListas.isSelected()){
            ...
            for(int i=0; i<this.rowsvivas;i++){
               ...
               titulo=this.JTTABLACREAR.getValueAt(i, 0).toString();
                autor=(String) this.JTTABLACREAR.getValueAt(1, 1);
                fecha=this.JTTABLACREAR.getValueAt(i, 2).toString();
                paginas = Integer.parseInt(this.JTTABLACREAR.getValueAt(i, 3).toString());
                idioma= this.JTTABLACREAR.getValueAt(i, 4).toString();
                tema= this.JTTABLACREAR.getValueAt(i, 5).toString();
                t1= new Texto(codigo+i, titulo, autor, fecha, paginas, idioma, tema);
                listacodigo.add(new Nodo(t1));
                listatitulo.add(new Nodo(t1));
                listaautor.add(new Nodo(t1));
                
            }
            for(int j=0; j<this.JTTABLACREAR.getRowCount();j++)
                for(int i=0; i<this.JTTABLACREAR.getColumnCount();i++)
                    this.JTTABLACREAR.setValueAt("", j, i);
    ...
    private void JBagregarAFavoritosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBagregarAFavoritosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JBagregarAFavoritosActionPerformed
