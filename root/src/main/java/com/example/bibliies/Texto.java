...
public class Texto  implements Parcelable {
   ...
   private static int contador = 1;
    ...
    protected Texto(Parcel in) {
        ...
        numeroPaginas = in.readInt();
        idioma = in.readString();
        tema = in.readString();
        numeroCalificaciones = in.readInt();
        calificacion = in.readDouble();
        tamaño = in.readInt();
        posicionador = in.readInt();
    }
